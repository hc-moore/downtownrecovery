#===============================================================================
# Compare downtowns, but for US cities only use provider 190199, and
# standardize by MSA
#===============================================================================
...
each_cr_plotly <-
  ...
  layout(title = "Recovery rate for alternative downtowns, standardized using MSA, US cities using only 190199 (11 week rolling average)",
...
saveWidget(
  each_cr_plotly,
  'C:/Users/jpg23/UDP/downtown_recovery/sensitivity_analysis/compare_downtowns_MSA_USonly190199.html')
