...
dbutils.widgets.dropdown('metric', 'downtown', ['downtown', 'relative'])
dbutils.widgets.dropdown('period', '1', ['1', '2', 'all'])
...
pretty_variables = {#'total_pop_downtown',
                    #'total_pop_city',
                    #'pct_singlefam_downtown',
                    #'pct_singlefam_city',
                    'pct_multifam_downtown':'% Multi-Family Homes',
                    #'pct_multifam_city',
                    #'pct_mobile_home_and_others_city',
                    'pct_renter_downtown':'% Renters',
                    #'pct_renter_city',
                    #'median_age_downtown',
                    #'median_age_city',
                    'bachelor_plus_downtown':'% Residents with Bachelor''s Degrees and Above',
                    #'bachelor_plus_city',
                    'median_hhinc_downtown':'Median Household Income ($)', # specify inflation adjustment in text
                    #'median_hhinc_city',
                    #'median_rent_downtown',
                    #'median_rent_city',
                    'pct_vacant_downtown':'% Vacant Housing Units',
                    #'pct_vacant_city',
                    #'pct_commute_auto_downtown',
                    #'pct_commute_auto_city',
                    'pct_commute_public_transit_downtown':'Mode Share Public Transit',
                    #'pct_commute_public_transit_city':'Mode Share Public Transit',
                    ...
                    #'housing_units_city',
                    'average_commute_time_downtown':'Average Commute Time (minutes)',
                    #'average_commute_time_city':'Average Commute Time (minutes)',
                    #'pct_jobs_agriculture_forestry_fishing_hunting',
                    #'pct_jobs_mining_quarrying_oil_gas',
                    #'pct_jobs_utilities',
                    #'pct_jobs_construction',
                    'pct_jobs_manufacturing':'% Jobs Manufacturing',
                    #'pct_jobs_wholesale_trade',
                    #'pct_jobs_retail_trade',
                    #'pct_jobs_transport_warehouse',
                    'pct_jobs_information':'% Jobs Information',
                    'pct_jobs_finance_insurance':'% Jobs Finance and Insurance',
                    #'pct_jobs_real_estate',
                    'pct_jobs_professional_science_techical':'% Jobs Professional, Science, Technical',
                    #'pct_jobs_management_of_companies_enterprises',
                    #'pct_jobs_administrative_support_waste',
                    'pct_jobs_educational_services':'% Jobs Education',
                    'pct_jobs_healthcare_social_assistance':'% Jobs Healthcare and Social Assistance',
                    'pct_jobs_arts_entertainment_recreation':'% Jobs Arts and Entertainment',
                    'pct_jobs_accomodation_food_services':'% Jobs Accomodation and Food',
                    'pct_jobs_public_administration':'% Jobs Public Administration',
                    'employment_entropy':'Employment Entropy',
                    #'population_density_downtown',
                    #'population_density_city',
                    'employment_density_downtown':'Employment Density', 
                    #'housing_density_downtown',
                    #'housing_density_city',
                    #'days_school_closing',
                    #'days_workplace_closing',
                    'days_cancel_large_events':'Days Cancel Large Events',
                    'days_cancel_all_events':'Days Cancel All Events',
                    'days_stay_home_requirements':'Days Stay at Home Requirements',
                    'days_income_support':'Days Income Support',
                    #'days_mask_mandates', 
                    'winter_avg_temp':'Winter Average Temperature', 
                    #'spring_avg_temp', 
                    'summer_avg_temp':'Summer Average Temperature'
                    #'fall_avg_temp'
}

# COMMAND ----------

pd1 = get_table_as_pandas_df("rq_dwtn_clusters_0823_period_1")
display(pd1[pd1["cluster"]==1])
...
if dbutils.widgets.get('metric') == 'downtown':
    ...
    if dbutils.widgets.get('period') == '1':
        ...
        important_features = ['pct_jobs_information', 'pct_jobs_finance_insurance', 'pct_jobs_professional_science_techical',
                              'pct_jobs_healthcare_social_assistance', 'pct_jobs_arts_entertainment_recreation', 'pct_jobs_manufacturing',
                              'employment_entropy', 'bachelor_plus_downtown', 'pct_multifam_downtown',
                              'pct_renter_downtown', 'pct_commute_public_transit_city', 'average_commute_time_city', 
                              'days_stay_home_requirements', 'days_cancel_large_events', 'winter_avg_temp']
        
        pretty_variables = {#'pct_jobs_agriculture_forestry_fishing_hunting',
                    #'pct_jobs_mining_quarrying_oil_gas',
                    #'pct_jobs_utilities',
                    #'pct_jobs_construction',
                    'pct_jobs_manufacturing':'% Jobs Manufacturing',
        ...
        important_features = ['pct_jobs_professional_science_techical', 'pct_jobs_finance_insurance', 'pct_jobs_arts_entertainment_recreation',
                              'pct_jobs_accomodation_food_services', 'employment_entropy', 'employment_density_downtown',
                              'pct_multifam_downtown', 'bachelor_plus_downtown', 'median_hhinc_downtown',
                              'average_commute_time_city', 'pct_commute_public_transit_city', 'days_stay_home_requirements',
                              'days_cancel_all_events','winter_avg_temp', 'summer_avg_temp']  
        pretty_variables = {#'pct_jobs_agriculture_forestry_fishing_hunting',
                    #'pct_jobs_mining_quarrying_oil_gas',
                    #'pct_jobs_utilities',
                    #'pct_jobs_construction',
                   ...
                   # 'pct_jobs_information':'% Jobs Information',
                    ...
                    #'pct_commute_auto_downtown',
                    #'pct_commute_auto_city',
                    #'pct_commute_public_transit_downtown':'Mode Share Public Transit Citywide',
                    'pct_commute_public_transit_city':'Mode Share Public Transit',
                    #'pct_commute_bicycle_downtown',
                    #'pct_commute_bicycle_city',
                    #'pct_commute_walk_downtown',
    ...
    color_map = {'Cluster 1':'#ffff99',
                 'Cluster 2':'#7fc97f',
                 'Cluster 3':'#1f78b4',
                 'Cluster 4': '#e41a1c'}
    
    important_features = ['pct_jobs_information', 'pct_jobs_professional_science_techical', 'pct_jobs_finance_insurance', 
                          'pct_jobs_healthcare_social_assistance', 'pct_jobs_public_administration', 'employment_entropy', 
                          'bachelor_plus_downtown', 'median_hhinc_downtown', 'median_rent_downtown',
                          'pct_vacant_downtown',  'average_commute_time_city', 'pct_commute_public_transit_city', 
                          'days_stay_home_requirements','days_cancel_all_events', 'winter_avg_temp']
    ...
    pretty_variables = { #'pct_jobs_agriculture_forestry_fishing_hunting',
                    ...
                    #'median_hhinc_city',
                    'median_rent_downtown':'Median Rent ($)',
                    #'median_rent_city',
                    'pct_vacant_downtown':'% Vacant Housing Units',
                    #'pct_vacant_city',
                    #'pct_commute_auto_downtown',
...
rfc_table = rfc_data[~rfc_data['city'].isin(['Dallas','Orlando','Mississauga','Hamilton','Oklahoma City'])]
rfc_table = rfc_table.replace('Québec','Quebec')
rfc_table = rfc_table.replace('Montréal','Montreal')
    
rfc_table = rfc_table[['city'] + subset_features]
...
# create features df
features_df = rfc_table.melt(id_vars = ['city', 'description', 'cluster'])
features_df['var'] = features_df['variable'].map(pretty_variables)
features_df['cluster'] = features_df['cluster'].astype(str)
...
fig = px.box(features_df, x = 'value', y = 'description', color = 'description',
               ...
               facet_row_spacing = .035, 
               facet_col_spacing = .035,
               #facet_col = 'variable',
               facet_col = 'var', 
               facet_col_wrap = 3,
               height = 125 * len(subset_features), 
               width = 125 * len(subset_features)
              # height = 75 * len(subset_features), 
...
#fig.update_layout(
#    title={
#        #'text': 'Period ' + dbutils.widgets.get('period') + ' ' + dbutils.widgets.get('subset') + ' variables',
#        'y':1,
#        'x':0.5,
#        'xanchor': 'center',
#        'yanchor': 'top'})
...
fig.for_each_annotation(lambda a : a.update(text=a.text.replace("var=", "")))
