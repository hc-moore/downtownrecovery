...
dbutils.widgets.dropdown('subset', 'important', ['Oxford', 'LEHD', 'important', 'all'])
...
lq_clusters = get_table_as_pandas_df("lq_clusters_single_period_4")
display(lq_clusters)
...
if dbutils.widgets.get('metric') == 'downtown':
    ...
    if dbutils.widgets.get('period') == '1':
        ...
        color_map ={
                   ...
                   'Cluster 2.4':'#bebada',
                   'Cluster 2.5':'#e7298a'}
        rfc_important_features = ['pct_jobs_professional_science_techical', 'pct_commute_public_transit_city', 'winter_avg_temp', 'summer_avg_temp', 
                              'pct_jobs_public_administration', 'pct_commute_auto_city', 'pct_jobs_educational_services',
                              'employment_density_downtown', 'bachelor_plus_downtown', 'pct_jobs_information','pct_multifam_downtown',
                              'population_density_downtown', 'median_hhinc_downtown', 'average_commute_time_city', 'pct_jobs_retail_trade', 'days_cancel_all_events',
                              'pct_jobs_accomodation_food_services', 'pct_jobs_arts_entertainment_recreation', 'median_age_downtown','days_stay_home_requirements'] # not yet supported
    ...
    rfc_important_features = ['employment_density_downtown', 'pct_jobs_information',
                              ...
                              'median_rent_city',    'pct_commute_others_city',
                              #'housing_units_downtown',
                              'housing_units_city', 'pct_jobs_mining_quarrying_oil_gas', 'pct_jobs_utilities','pct_jobs_construction', 'pct_jobs_manufacturing','pct_jobs_wholesale_trade','pct_jobs_transport_warehouse', 'pct_jobs_finance_insurance', 'pct_jobs_real_estate','pct_jobs_professional_science_techical','pct_jobs_management_of_companies_enterprises','pct_jobs_administrative_support_waste','pct_jobs_educational_services','pct_jobs_healthcare_social_assistance','pct_jobs_arts_entertainment_recreation','pct_jobs_public_administration', 'employment_entropy',#'housing_density_downtown',
                              'housing_density_city', 'days_school_closing', 'days_cancel_all_events', 'days_income_support','days_mask_mandates', 'winter_avg_temp', 'spring_avg_temp', 'summer_avg_temp', 'fall_avg_temp']
