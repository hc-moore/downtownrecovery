#===============================================================================
# Create dataset to update trends page for June 2024
#===============================================================================
...
filepath <- '/Users/jpg23/data/downtownrecovery/spectus_exports/trend_page_updates/june_2024/'

# Downtowns: 5/26/24 - 7/7/24 (but filter to end of June)
dt <-
...
# MSAs: 5/26/24 - 7/7/21 (but filter to end of June)
msa <-
...
saveWidget(
  dt_outliers_unique,
  '/Users/jpg23/UDP/downtown_recovery/trend_updates/june_2024/unique_devices_outliers_vs_not.html')
...
saveWidget(
  dt_outliers_total,
  '/Users/jpg23/UDP/downtown_recovery/trend_updates/june_2024/total_stops_outliers_vs_not.html')
...
saveWidget(
  msa_distinct,
  '/Users/jpg23/UDP/downtown_recovery/trend_updates/june_2024/msa_distinct.html')
...
saveWidget(
  norm_dist,
  '/Users/jpg23/UDP/downtown_recovery/trend_updates/june_2024/normalized_distinct.html')
...
write.csv(final_df1,
          '/Users/jpg23/data/downtownrecovery/stop_uplevelled_2023_2024/stopuplevelled_june_2024_outliers_removed.csv',
          row.names = F)
